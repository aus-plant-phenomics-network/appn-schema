...
class IssueMessage(str, Enum):
    ...
    RANGE_CLASS_NOT_SELECTED = (
        "A spreadsheet column or property name matches a property with more than one APPN schema class in its range, so the class for the associated value could not be uniquely determined.",
