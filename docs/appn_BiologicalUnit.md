...
## Properties
* appn:BiologicalUnit **appn:hasBiologicalUnitType** [appn:BiologicalUnitType](/docs/appn_BiologicalUnitType.md)
    * Links a BiologicalUnit to its type.
* [appn:Sample](/docs/appn_Sample.md) **appn:derivesFrom** appn:BiologicalUnit
    * Identifies the BiologicalUnit from which a Sample was sampled.
* appn:BiologicalUnit **appn:hasBiologicalMaterial** [appn:BiologicalMaterial](/docs/appn_BiologicalMaterial.md)
